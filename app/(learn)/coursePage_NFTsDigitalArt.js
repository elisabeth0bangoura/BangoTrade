...
const Courses = () => {
  ...
  const Data = [
    ...
    { 
      id: 1, 
      section: "1",
      question: t("nftQuestion1"),
      rightanswer: t("nftRightAnswer1"),
      all_answers: [
        t("nftA1"),
        t("nftB1"),
        t("nftC1"),
    ...
    { 
      id: 2, 
      section: "2",
      question: t("nftQuestion2"),
      rightanswer: t("nftRightAnswer2"),
      all_answers: [
        t("nftA2"),
        t("nftB2"),
        t("nftC2"),
    ...
    { 
      id: 3, 
      section: "3",
      question: t("nftQuestion3"),
      rightanswer: t("nftRightAnswer3"),
      all_answers: [
        t("nftA3"),
        t("nftB3"),
        t("nftC3"),
      ...
      explanation: t("nftExplanation3"),
    },
    
    { 
      id: 4, 
      section: "4",
      question: t("nftQuestion4"),
      rightanswer: t("nftRightAnswer4"),
      all_answers: [
        t("nftA4"),
        t("nftB4"),
        t("nftC4"),
            ...
            <View style={{
             ...
             <TouchableOpacity
              ...
              onPress={() => {
                ...
                database()
                .ref(`/users/${user}/Courses/NFTs`)
                .set({
                  status: "started",
                  courseName: "NFTs and Digital Art",
            ...
            <BottomSheetScrollView contentContainerStyle={{
              ...
              <Text style={{
                ...
                {t("congratulationsMessage2")}
                    ...
                    .then(() => {
                      console.log('Data set.')
                      router.push("/(learn)/artikelCryptoTradingBasics")
                    })
