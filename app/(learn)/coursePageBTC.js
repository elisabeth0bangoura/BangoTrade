...
const Data = [
  { 
    id: 1, 
    section: "1",
    question: t("questionBTC1"),
    rightanswer: t("rightAnswerBTC1"),
    all_answers: [
      t("A_21_millionBTC1"),
      t("B_50_millionBTC1"),
      t("C_100_millionBTC1"),
    ...
    explanation: t("explanatioBTC1")
  },
  { 
    id: 2, 
    section: "2",
    question: t("questionBTC2"),
    rightanswer: t("rightAnswerBTC2"),
    all_answers: [
      t("A_1_controlled_by_authorityBTC2"),
      t("B_2_recorded_in_public_ledgerBTC2"),
      t("C_3_anonymous_and_untraceableBTC2"),
      t("D_4_traditional_database_systemBTC2"),
    ],
    explanation: t("explanationBTC2")
  },
];
            ...
            <View style={{
             ...
             <TouchableOpacity
              ...
              onPress={() => {
                ...
                database()
                .ref(`/users/${user}/Courses/Intoduction_To_Bitcoin`)
                .set({
                  status: "started",
                  courseName: "Intoduction to Bitcoin",
                    ...
                    <TouchableOpacity 
                      onPress={() => {
                        database()
                          ...
                          .then(() => {
                            console.log('Data set.');
                            router.push("/(learn)/artikelPageETH_SmartContracts");
                          })
                          .catch((err) => {
                            console.log(err);
                          });
