...
useEffect(() => {
  ...
  const Data = [
    { 
      id: 1, 
      section: "1",
      question: t("cryptoWalletQuestion1"),
      rightanswer: t("cryptoWalletRightAnswer1"),
      all_answers: [
       t("cryptoWalletA1"),
       t("cryptoWalletB1"),
       t("cryptoWalletC1"),
      ...
      explanation: t("cryptoWalletExplanation1"),
    },
    { 
      id: 2, 
      section: "2",
      question: t("cryptoWalletQuestion2"),
      rightanswer: t("cryptoWalletRightAnswer2"),
      all_answers: [
        t("cryptoWalletA2"),
        t("cryptoWalletB2"),
        t("cryptoWalletC2"),
      ...
      explanation: t("cryptoWalletExplanation2"),
    },
    { 
      id: 3, 
      section: "3",
      question: t("cryptoWalletQuestion3"),
      rightanswer: t("cryptoWalletRightAnswer3"),
      all_answers: [
        t("cryptoWalletA3"),
        t("cryptoWalletB3"),
        t("cryptoWalletC3"),
      ...
      explanation: t("cryptoWalletExplanation3"),
    },
    { 
      id: 4, 
      section: "4",
      question: t("cryptoWalletQuestion4"),
      rightanswer: t("cryptoWalletRightAnswer4"),
      all_answers: [
        t("cryptoWalletA4"),
        t("cryptoWalletB4"),
        t("cryptoWalletC4"),
      ...
      explanation: t("cryptoWalletExplanation4"),
    },
  ];
            ...
            <View style={{
             ...
             <TouchableOpacity
              ...
              onPress={() => {
                ...
                database()
                .ref(`/users/${user}/Courses/CryptoWalletAndSecurity`)
                .set({
                  status: "started",
                  courseName: "Crypto Wallet and Security",
               ...
               alignItems: 'center',
                ...
                <Text style={{
                  ...
                  {t("congratulationsMessage2")}
                    ...
                    .then(() => {
                      console.log('Data set.')
                      router.push("/(learn)/artikelNFTsandDigitalArt")
                    })
