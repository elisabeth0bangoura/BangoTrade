...
const Data = [
  ...
  { 
    id: 1, 
    section: "1",
    question: t("cryptoTaxQuestion1"),
    rightanswer: t("cryptoTaxRightAnswer1"),
    all_answers: [
     t("cryptoTaxA1"),
     t("cryptoTaxB1"),
      t("cryptoTaxC1"),
    ...
    explanation: t("cryptoTaxExplanation1"),
  },
  ...
  { 
    id: 2, 
    section: "2",
    question: t("cryptoTaxQuestion2"),
    rightanswer: t("cryptoTaxRightAnswer2"),
    all_answers: [
      t("cryptoTaxA2"),
      t("cryptoTaxB2"),
      t("cryptoTaxC2"),
    ...
    explanation: t("cryptoTaxExplanation2")
  },
  ...
  { 
    id: 3, 
    section: "3",
    question: t("cryptoTaxQuestion3"),
    rightanswer: t("cryptoTaxRightAnswer3"),
    all_answers: [
      t("cryptoTaxA3"),
      t("cryptoTaxB3"),
      t("cryptoTaxC3"),
    ...
    explanation: t("cryptoTaxExplanation3")
  },
  ...
  { 
    id: 4, 
    section: "4",
    question: t("cryptoTaxQuestion4"),
    rightanswer: t("cryptoTaxRightAnswer4"),
    all_answers: [
     t("cryptoTaxA4"),
     t("cryptoTaxB4"),
      t("cryptoTaxC4"),
    ...
    explanation: t("cryptoTaxExplanation4")
  }
];
            ...
            <View style={{
             ...
             <TouchableOpacity
              ...
              onPress={() => {
                ...
                database()
                .ref(`/users/${user}/Courses/Crypto_Taxes_And_Accounting`)
                .set({
                  status: "started",
                  courseName: "Crypto Taxes and Accounting",
