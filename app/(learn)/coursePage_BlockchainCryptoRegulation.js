...
const Courses = () => {
  ...
  const Data = [
    ...
    { 
      id: 1, 
      section: "1",
      question: t("cryptoRegulationQuestion1"),
      rightanswer: t("cryptoRegulationRightAnswer1"),
      all_answers: [
       t("cryptoRegulationA1"),
        t("cryptoRegulationB1"),
        t("cryptoRegulationC1"),
        t("cryptoRegulationD1"),
      ],
      explanation: t("cryptoRegulationExplanation1"),
    },
    ...
    { 
      id: 2, 
      section: "2",
      question: t("cryptoRegulationQuestion2"),
      rightanswer: t("cryptoRegulationRightAnswer2"),
      all_answers: [
       t("cryptoRegulationA2"),
        t("cryptoRegulationB2"),
        t("cryptoRegulationC2"),
        t("cryptoRegulationD2"),
      ],
      explanation: t("cryptoRegulationExplanation2"),
    },
    ...
    { 
      id: 3, 
      section: "3",
      question: t("cryptoRegulationQuestion3"),
      rightanswer: t("cryptoRegulationRightAnswer3"),
      all_answers: [
       t("cryptoRegulationA3"),
       t("cryptoRegulationB3"),
       t("cryptoRegulationC3"),
       t("cryptoRegulationD3"),
      ],
      explanation: t("cryptoRegulationExplanation3"),
    },
    
    { 
      id: 4, 
      section: "4",
      question: t("cryptoRegulationQuestion4"),
      rightanswer: t("cryptoRegulationRightAnswer4"),
      all_answers: [
        t("cryptoRegulationA4"),
        t("cryptoRegulationB4"),
        t("cryptoRegulationC4"),
        t("cryptoRegulationD4"),
      ],
      explanation: t("cryptoRegulationExplanation4"),
    }
  ];
            ...
            <View style={{
             ...
             <TouchableOpacity
              ...
              onPress={() => {
                ...
                database()
                .ref(`/users/${user}/Courses/Blockchain_Crypto_Regulation`)
                .set({
                  status: "started",
                  courseName: "Blockchain and Crypto Regulation",
              ...
              <BottomSheetScrollView contentContainerStyle={{
                ...
                <Text style={{
                  ...
                  {t("congratulationsMessage2")}
                    ...
                    .then(() => {
                      console.log('Data set.')
                      router.push("/(learn)/artikelFutureCryptocurrencies")
                    })
