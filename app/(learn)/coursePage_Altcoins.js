...
const Data = [
  { 
    id: 1, 
    section: "1",
    question: t("altcoinQuestion1"),
    rightanswer: t("altcoinRightAnswer1"),
    all_answers: [
      t("altcoinA1"),
      t("altcoinB1"),
      t("altcoinC1"),
    ...
    explanation: t("altcoinExplanation1")
  },
  { 
    id: 2, 
    section: "2",
    question: t("ethereumQuestion2"),
    rightanswer: t("ethereumRightAnswer2"),
    all_answers: [
      t("ethereumA2"),
      t("ethereumB2"),
      t("ethereumC2"),
    ...
    explanation: t("ethereumExplanation2")
  },
  { 
    id: 3, 
    section: "3",
    question: t("ethereumQuestion3"),
    rightanswer: t("ethereumRightAnswer3"),
    all_answers: [
      t("ethereumA3"),
      t("ethereumB3"),
      t("ethereumC3"),
    ...
    explanation: t("ethereumExplanation3")
  },

  { 
    id: 4, 
    section: "4",
    question: t("altcoinsQuestion4"),
    rightanswer: t("altcoinsRightAnswer4"),
    all_answers: [
      t("altcoinsA4"),
      t("altcoinsB4"),
      t("altcoinsC4"),
    ...
    explanation: t("altcoinsExplanation4")
  },
            ...
            <View style={{
             ...
             <TouchableOpacity
              ...
              onPress={() => {
                ...
                database()
                .ref(`/users/${user}/Courses/Understanding_Altcoins`)
                .set({
                  status: "started",
                  courseName: "Understanding Altcoins",
