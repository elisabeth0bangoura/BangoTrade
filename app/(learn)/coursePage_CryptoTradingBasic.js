...
const Courses = () => {
  ...
  const Data = [
    ...
    { 
      id: 1, 
      section: "1",
      question: t("cryptoTradingQuestion1"),
      rightanswer: t("cryptoTradingRightAnswer1"),
      all_answers: [
        t("cryptoTradingA1"),
        t("cryptoTradingB1"),
        t("cryptoTradingC1"),
      ...
      explanation: t("cryptoTradingExplanation1"),
    },
    ...
    { 
      id: 2, 
      section: "2",
      question: t("cryptoTradingQuestion2"),
      rightanswer: t("cryptoTradingRightAnswer2"),
      all_answers: [
        t("cryptoTradingA2"),
        t("cryptoTradingB2"),
        t("cryptoTradingC2"),
      ...
      explanation: t("cryptoTradingExplanation2"),
    },
    ...
    { 
      id: 3, 
      section: "3",
      question: t("cryptoTradingQuestion3"),
      rightanswer: t("cryptoTradingRightAnswer3"),
      all_answers: [
        t("cryptoTradingA3"),
        t("cryptoTradingB3"),
        t("cryptoTradingC3"),
      ...
      explanation: t("cryptoTradingExplanation3")
    },
    
    { 
      id: 4, 
      section: "4",
      question: t("cryptoTradingQuestion4"),
      rightanswer: t("cryptoTradingRightAnswer4"),
      all_answers: [
        t("cryptoTradingA4"),
        t("cryptoTradingB4"),
        t("cryptoTradingC4"),
      ...
      explanation: t("cryptoTradingExplanation4")
    }
  ];
            ...
            <View style={{
             ...
             <TouchableOpacity
              ...
              onPress={() => {
                ...
                database()
                .ref(`/users/${user}/Courses/TradingBasics`)
                .set({
                  status: "started",
                  courseName: "Trading Basics",
              ...
              <BottomSheetScrollView contentContainerStyle={{
                ...
                <Text style={{
                  ...
                  {t("congratulationsMessage2")}
                    ...
                    .then(() => {
                      console.log('Data set.')
                      router.push("/(learn)/artikelBlockchainCryptoRegulation")
                    })
