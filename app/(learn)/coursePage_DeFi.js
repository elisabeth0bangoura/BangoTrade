...
const Courses = () => {
  ...
  const Data = [
    { 
      id: 1, 
      section: "1",
      question: t("deFiQuestion1"),
      rightanswer: t("deFiRightAnswer1"),
      all_answers: [
        t("deFiA1"),
        t("deFiB1"),
        t("deFiC1"),
      ...
      explanation: t("deFiExplanation1")
    },
    { 
      id: 2, 
      section: "2",
      question: t("deFiQuestion2"),
      rightanswer: t("deFiRightAnswer2"),
      all_answers: [
        t("deFiA2"),
        t("deFiB2"),
        t("deFiC2"),
      ...
      explanation: t("deFiExplanation2"),
    },
    { 
      id: 3, 
      section: "3",
      question: t("deFiQuestion3"),
      rightanswer: t("deFiRightAnswer3"),
      all_answers: [
       t("deFiA3"),
       t("deFiB3"),
       t("deFiC3"),
      ...
      explanation: t("deFiExplanation3")
    }
  ];
                ...
                <Text style={{
                 ...
                 {t("congratulationsMessage1")}
                  ...
                  {t("congratulationsMessage2")}
                    ...
                    .then(() => {
                      console.log('Data set.')
                      router.push("/(learn)/artikelCryptoWalletsSecurity")
                    })
