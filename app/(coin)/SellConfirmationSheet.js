       ...
       style={{
         ...
         <ScrollView style={{
           ...
           //  SheetManager.hide("OrderType_Sheet");
             SheetManager.show("SellAmounts_Sheet");
...
const SellConfirmationSheet =  React.memo(() => {
  ...
  const SellConfirmation_Sheet = useRef(null); // ✅ Correct ref type
      ...
      const fetchAssetData = async () => {
        try {
          const res = await fetch(
            `https://broker-api.sandbox.alpaca.markets/v1/trading/accounts/${AlpacaUserId}/positions/${coinSymbol}USD`,
            options
          );
...
export default SellConfirmationSheet;