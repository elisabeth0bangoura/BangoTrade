...
export default function SettingsNotification() {
  ...
  const { CurrentViewMode, setCurrentViewMode, themes } = useContext(ViewModeContext);
    ...
    const SettingsNotification_Sheet = useRef(null);
  ...
  return( 
    ...
    ref={SettingsNotification_Sheet}
  ...
  <Text style={{
     ...
     {t("NotificationsTitleInNotificationsComponent")}  
      </Text>
    ...
    {t("NotificationsSubTextInNotificationsComponent")}  
      </Text>
...
<View style={{
    ...
    {t("EMailTextInNotificationsComponent")}  
...
thumbColor={isEnabledEmail ? CurrentViewMode.Mode_bg : CurrentViewMode.Mode_bg}
...
<View style={{
    ...
    {t("PushNotificationsTextInNotificationsComponent")}  
    </Text>
...
trackColor={{ false: CurrentViewMode.Mode_fontColor, true: CurrentViewMode.Mode_fontColor }}
thumbColor={isEnabledPushNotifications ? CurrentViewMode.Mode_bg : CurrentViewMode.Mode_bg}
ios_backgroundColor={CurrentViewMode.Mode_fontColor}
 onValueChange={toggleSwitchPushNotifications}
 value={isEnabledPushNotifications}
 />
