...
export default function OtherServices() {
  ...
  const { CurrentViewMode, setCurrentViewMode, themes } = useContext(ViewModeContext);
    ...
    const OtherServices_Sheet = useRef(null);
  ...
  <Text style={{
    ...
    {t("OtherServicesTitleInOtherServicesComponent")}  
      </Text>
...
<View> 
    ...
    {t("LegalDocumentsTextInOtherServicesComponent")}  
    ...
    {t("LegalDocumentsSubTextInOtherServicesComponent")}  
...
<View> 
    <Text style={{
      ...
      {t("CloseDepotTextInOtherServicesComponent")}  
    ...
    <Text numberOfLines={1} style={{
     ...
     {t("CloseDepotSubTextInOtherServicesComponent")}  
