...
const BankTypeCodes =  React.memo(({ AssetSupply}) => {
  ...
  const { CurrentViewMode, setCurrentViewMode, themes } = useContext(ViewModeContext);
    ...
    const BankTypeCodes_Sheet = useRef(null);
...
<Text style={{
		...
		Bank Code type
         ...
         <TouchableOpacity onPress={() => {
          setBankCodeType("ABA")
         SheetManager.hide("BankTypeCodes_Sheet")
         }}
         style={{
          marginTop: height(3),
          paddingVertical: 12,
