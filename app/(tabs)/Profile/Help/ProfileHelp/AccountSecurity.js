...
At Bantico, your security is our top priority. 
To protect your account and personal information, follow these steps:
  </Text>
...
<Text style={{
  ...
  <Text  style={{
    ...
    color: CurrentViewMode.Mode_fontColor,
    lineHeight: height(2.7)
  }}>• PIN management: </Text> We will never ask for your PIN or SMS verification code. 
  Do not share these details with anyone. Do not save your login PINs on your phone, 
  and do not use the same PIN for your phone and Bantico. 
  If you're concerned that someone knows your PIN, change it in the app.
...
<Text style={{
  ...
  <Text  style={{
    ...
    color: CurrentViewMode.Mode_fontColor,
    lineHeight: height(2.7)
  }}>• Transfers: </Text> Be cautious when sharing your account details 
  with strangers and when requesting to receive or transfer money. Always 
  verify the legitimacy of financial requests or offers before acting.
...
<Text style={{
  ...
  <Text  style={{
    ...
    color: CurrentViewMode.Mode_fontColor,
    lineHeight: height(2.7)
  }}>• Communication: </Text> Verify that emails from Bantico originate from our 
  official domains: @bantico.com and @news.bantico.com.
  Scammers may also create misleading pages.
  Watch out for fake links that resemble our website.
...
We're here to support you every step of the way. Your safety is our top priority.
  </Text>
