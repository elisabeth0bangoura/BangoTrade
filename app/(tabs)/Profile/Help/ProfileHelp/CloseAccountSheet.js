...
Before you proceed to close your account, please make sure that your account is empty, meaning all securities are sold and all cash is transferred to your reference account.
...
Please note the following before closing your account:
</Text>
...
<Text style={{
  ...
  <Text  style={{
    ...
    color: CurrentViewMode.Mode_fontColor,
    lineHeight: height(2.7)
  }}>- Account closure is permanent </Text> Once your account is closed you will not be able to reopen it again
</Text>
...
<Text style={{
  ...
  <Text  style={{
    ...
    color: CurrentViewMode.Mode_fontColor,
    lineHeight: height(2.7)
  }}>- Limited access </Text>After confirming account closure, trading and paying in will be disabled, but access to invoices and reports will remain available
</Text>
...
<Text style={{
  ...
  <Text  style={{
    ...
    color: CurrentViewMode.Mode_fontColor,
    lineHeight: height(2.7)
  }}>- Card termination </Text>After confirming account closure, card payments and sending money to card will be disabled
</Text>
