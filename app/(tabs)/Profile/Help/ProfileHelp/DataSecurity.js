...
export default function DataSecuritySheet () {
  ...
  const { t } = useTranslation();
    ...
    const DataSecurity_Sheet = useRef(null);
  ...
  useEffect(() => {
    posthog.capture('screen_viewed', {
      screen: 'DataSecurity_Sheet',
      $screen_name: 'DataSecurity_Sheet',
...
Your personal data is stored in a high-performance data center 
in The United States of America in accordance with the highest security standards (ISO 27001).
  </Text>
...
<Text style={{
  ...
  Please note: Data protection is very important to us.
  You can find our privacy policy on our <Text style={{
  fontWeight: "bold", 
  color: CurrentViewMode.Mode_CashChart_Cash}}>website </Text>.
  </Text>
  ...
  <View style={{
    ...
    flexDirection: 'row',
      ...
      <TouchableOpacity onPress={() => {
            ...
            posthog.capture('close_data_security_Sheet', {
              screen: 'DataSecurity_Sheet',
              $screen_name: 'DataSecurity_Sheet',
              timestamp: new Date().toISOString(),
            });
      ...
      SheetManager.hide("DataSecurity_Sheet"); // Now hide the sheet after a delay
