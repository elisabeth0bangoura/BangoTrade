...
Cash balances in Bantico escrow accounts at our partner banks are 
protected by deposit insurance up to $100,000. Funds diversified in liquidity funds 
are secured in separate custody accounts.
  </Text>
...
<Text style={{
  ...
  <Text  style={{
    ...
    color: CurrentViewMode.Mode_fontColor,
    lineHeight: height(2.7)
  }}>• Deposit protection: </Text> Funds at our broker partner Alpaca Crypto LLC and Alpaca Securities LLC
are protected up to €100,000 per customer and per account.
</Text>
...
<Text style={{
  ...
  <Text  style={{
    ...
    color: CurrentViewMode.Mode_fontColor,
    lineHeight: height(2.7)
  }}>• Separate custody account: </Text> The funds diversified in the money market are 
  held directly in your name in a separate custody account.
  These assets are subject to strict security regulations and are held separately 
  from Bantico's own assets. Security is unlimited.
...
You can see how your cash is distributed under <Text style={{
  fontWeight: "bold", 
  color: CurrentViewMode.Mode_CashChart_Cash}}>Interest Overview</Text>.
  </Text>
