...
Taxes already paid will be refunded in two cases:
</Text>
...
• <Text>Exemption order set up or changed: </Text> <Text style={{ fontWeight: "500",}}>
 If you set up an exemption order in the current year,
 taxes already paid will be refunded up to the amount of the exemption. For more information,
 see Exemption Order (FSA).</Text>
</Text>
...
• <Text>Loss-making business: </Text> <Text style={{ fontWeight: "500",}}>
Taxes paid earlier in the year can be refunded after a new loss-making business. 
For more information, see <Text style={{
  fontWeight: "900", 
  color: CurrentViewMode.Mode_CashChart_Cash,}}>Loss-making funds</Text>.
</Text>
</Text>
...
• <Text>Example: </Text> <Text style={{ fontWeight: "500",}}>
If €1,000.00 of an exemption order is used or €1,000.00 is 
offset against previous profits in loss offset funds, only the taxes on 
this amount (€250.00 capital gains tax plus solidarity surcharge and church tax) will be refunded.</Text>
</Text>
...
Taxes paid earlier in the year may be refunded after a new loss-making transaction.
For more information, see <Text style={{fontWeight: "bold", color: CurrentViewMode.Mode_CashChart_Cash}}>Tax Adjustments and Refunds</Text>.
  </Text>
