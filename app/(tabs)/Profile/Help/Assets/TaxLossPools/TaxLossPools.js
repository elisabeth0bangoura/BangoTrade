...
Capital gains tax is levied on interest, dividends, and the sale of securities.
Gains are first offset by potential losses before being taxed or reduced by the <Text 
  style={{
     fontSize: size(14),
      color: CurrentViewMode.Mode_CashChart_Cash,
  }}>
   Freehold Allowance (FSA)
  </Text>.
  </Text>
...
Losses are recorded in loss offset pools. You can view your loss offset pools in your <Text 
  style={{
     fontSize: size(14),
      color: CurrentViewMode.Mode_CashChart_Cash,
  }}>
...
There are three types of loss offset pools:
</Text>
...
• <Text>Stocks:</Text> <Text style={{ fontWeight: "500",}}>
Includes losses from stock sales.
These {`\n`} can only be used to reduce taxable gains from future {`\n`} stock sales.</Text>
</Text>
...
• <Text>Other instruments:</Text> <Text style={{ fontWeight: "500",}}>
Includes losses from sales of {`\n`} ETFs, bonds, and derivatives. 
These can be used to {`\n`} reduce any taxable gains.</Text>
</Text>
...
• <Text>Withholding tax:</Text> <Text style={{ fontWeight: "500",}}>
  Includes withholding tax paid in {`\n`} the current year. 
  This can be used to reduce all {`\n`} taxable profits.</Text>
</Text>
