...
In a reverse stock consolidation, a company reduces the number of shares by a certain ratio.
...
<Text style={{ fontWeight: "900", fontSize: size(14),}}>• Tradability: </Text> Following the merger, trading in the adjusted shares may be suspended for a short period.
{`\n`}However, trading will resume once the process is complete.
{`\n`}{`\n`}
 <Text style={{ fontWeight: "900", fontSize: size(14),}}>• Price Impact: </Text> The number of shares decreases, but the total value of your investment remains the same.
{`\n`}Consequently, the price per share increases proportionally.
{`\n`}{`\n`}
<Text style={{ fontWeight: "900", fontSize: size(14),}}>• Buying price:  </Text> It may take a few days for the buying price
...
<Text style={{
 ...
 Details on share consolidations can be found in the <Text> activity log</Text>
  </Text>
