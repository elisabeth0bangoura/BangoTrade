...
• A company has undertaken corporate actions {`\n`} such as stock splits or mergers. {`\n`}{`\n`}
• Trading in an instrument has been held. {`\n`}{`\n`}
• Stock market data is being transmitted with a {`\n`} delay. {`\n`}{`\n`}
