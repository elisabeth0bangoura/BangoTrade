       ...
       style={{
        ...
        alignSelf: 'center'
          ...
          <Text style={{
            ...
            ISIN change after corporate action
...
After a corporate action, a share may not be immediately tradable. 
The purchase price may be 0 and the name may be missing; 
this information will only be available a few days later.
...
<Text style={{ fontWeight: "900", fontSize: size(14),}}>•  Tradability:</Text> After a capital increase, a share is not immediately tradable, 
{`\n`}but only when it is listed with our trading partner Lang & Schwarz.
{`\n`}{`\n`}
 <Text style={{ fontWeight: "900", fontSize: size(14),}}>• ISIN:</Text> During a corporate action, the ISIN and name of a share may change. 
{`\n`}The old ISIN is removed from the books and the new ISIN is entered into the books.
{`\n`}{`\n`}
<Text style={{ fontWeight: "900", fontSize: size(14),}}>•  Purchase price:</Text> It may take a few days for the purchase price 
{`\n`}to be adjusted for the new position.
{`\n`}{`\n`}
</Text>
...
<Text style={{
 ...
 Details on corporate actions can be found in the <Text> activity log</Text>
  </Text>
