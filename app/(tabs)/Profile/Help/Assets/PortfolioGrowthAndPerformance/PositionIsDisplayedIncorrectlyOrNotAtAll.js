...
const formatMoneyMyInvestmnt = useCallback((price) => {
   ...
   />
       ...
       style={{
        ...
        alignSelf: 'center'
          ...
          Position is displayed incorrectly or not at all
 ...
 Your portfolio and current positions are updated in real time. 
 Corporate actions or delistings can impact your portfolio. 
 For instance, positions may no longer appear after a delisting.
...
Positions will no longer be displayed in the following cases:
</Text>
...
• A security is no longer listed on the stock {`\n`} exchange due to a corporate action (delisting). {`\n`} {`\n`}
• Trading in a security has been suspended. {`\n`} {`\n`}
• Stock exchange data is being transmitted with {`\n`} a delay. {`\n`} {`\n`}
...
Check your investments under <Text style={{
   fontSize: size(14),
     fontWeight: "bold",
   color: CurrentViewMode.Mode_CashChart_Cash,
}}>Current</Text> <Text style={{
   fontSize: size(14),
     fontWeight: "bold",
   color: CurrentViewMode.Mode_CashChart_Cash,
}}>Investments</Text>.
If your position is still not visible 2-3 business days after a corporate action, 
please contact us by selecting the relevant order or buy event in your transactions.
