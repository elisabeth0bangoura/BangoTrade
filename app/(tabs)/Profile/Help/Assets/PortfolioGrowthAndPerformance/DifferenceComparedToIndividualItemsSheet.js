   ...
   />
       ...
       style={{
        ...
        alignSelf: 'center'
          ...
          Difference compared to individual items
...
Your portfolio's performance is calculated based on the returns of all the instruments you've ever owned. 
This includes gains and losses from investments that are no longer part of your portfolio. 
<Text style={{
    fontSize: size(14),
   color: CurrentViewMode.Mode_CashChart_Cash,
}}>Calculating Performance</Text>
  </Text>
...
<Text style={{
 ...
 {`\n`}Therefore, the performance of your current investments may not match the performance of your overall portfolio.
