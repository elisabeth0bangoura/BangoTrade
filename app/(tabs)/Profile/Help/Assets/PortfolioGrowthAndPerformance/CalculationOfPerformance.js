...
export default function CalculationOfPerformanceSheet () {
...
const formatMoneyMyInvestmnt = useCallback((price) => {
  ...
  Your portfolio performance is calculated in real-time and displayed under <Text 
  style={{
     fontSize: size(14),
  ...
  During trading hours, the most recent bid prices are used for calculations. 
  Outside of trading hours, the latest available closing prices are used. 
  The performance of cryptocurrencies is always calculated based on the most recent buy prices.
