...
If an order is not executed, it may be related to the order type 
(market order, limit order, stop order). You can create, edit, 
and delete orders under <Text style={{
...
Orders will not be executed in the following cases:
  </Text>
...
<Text style={{ fontWeight: "900", fontSize: size(14),}}>• The trading venue suspends trading in the instrument. </Text> 
{`\n`}{`\n`}
 <Text style={{ fontWeight: "900", fontSize: size(14),}}>• There is no liquidity available to execute the {`\n`} order at market prices. </Text>
{`\n`}{`\n`}
<Text style={{ fontWeight: "900", fontSize: size(14),}}>• The limit price for limit orders or stop orders {`\n`} was not reached. </Text>
{`\n`}{`\n`}
</Text>
...
<Text style={{
 ...
 If you believe an order has failed in error, please select the relevant order to contact us.
