...
Limit orders and stop orders are set with a fixed expiration date.
Once the expiration date is reached, your order will automatically expire. 
You can view and adjust the expiration dates of your orders under <Text style={{
  color: CurrentViewMode.Mode_CashChart_Cash, 
  fontWeight: 'bold'}}>Orders</Text>. 
Additionally, the trading venue may cancel limit or stop orders due to upcoming corporate actions.
  </Text>
...
Orders will expire or be cancelled in the following cases:
  </Text>
...
<Text style={{ fontWeight: "900", fontSize: size(14),}}>• The expiration date of a limit order or stop {`\n`} order has been reached. </Text> 
{`\n`}{`\n`}
 <Text style={{ fontWeight: "900", fontSize: size(14),}}>• The trading venue ceases trading completely. </Text>
{`\n`}{`\n`}
<Text style={{ fontWeight: "900", fontSize: size(14),}}>• The trading venue cancels the order due to an {`\n`} impending dividend payment. </Text>
{`\n`}{`\n`}
</Text>
...
<Text style={{
 ...
 We will inform you via push notification when an order expires or is canceled.
 ...
 If you need help with a past order, please click on "Help" and select an order to start a chat.
  </Text>
