...
export default function CryptoSecuritySheet () {
  ...
  const { t } = useTranslation();
    ...
    const CryptoSecurity_Sheet = useRef(null);
  ...
  useEffect(() => {
    posthog.capture('screen_viewed', {
      screen: 'CryptoSecurity_Sheet',
      $screen_name: 'CryptoSecurity_Sheet',
...
Your crypto assets are securely held by Alpaca Crypto LLC, with cryptocurrency stored in wallets secured by Fireblocks' MPC-CMP architecture.
Fireblocks is a licensed money services business with FinCEN and holds SOC 2 Type II certification. Alpaca Crypto is also a licensed money services business with FinCEN and is SOC 2 Type II certified.

For further information on the custody and protection of crypto assets can be found under <Text style={{
...
<Text style={{
 ...
 If you need help with a past trade, please click on "Help" and select a trade to start a chat.
   </Text>
...
<TouchableOpacity onPress={() => {
         ...
         posthog.capture('close_cryptoSecurity_Sheet', {
          screen: 'CryptoSecurity_Sheet',
          $screen_name: 'CryptoSecurity_Sheet',
          timestamp: new Date().toISOString(),
        });
      ...
      SheetManager.hide("CryptoSecurity_Sheet"); // Now hide the sheet after a delay
