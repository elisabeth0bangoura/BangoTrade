...
const formatMoneyMyInvestmnt = useCallback((price) => {
  ...
  <Text style={{
   ...
   To qualify for a dividend or distribution, you must hold the relevant security 
   in your portfolio until the close of trading on the day before the ex-dividend date. 
   The number of shares you own at that time will be used to determine the dividend payment.
...
<Text style={{ fontWeight: "900", fontSize: size(14),}}>• Payday: </Text>The actual dividend is credited on payday, which may occur shortly after the ex-dividend date or a few weeks later. 
{`\n`}You can find the payday in the app under the security details or on the company or issuer's website.
{`\n`}{`\n`}
 <Text style={{ fontWeight: "900", fontSize: size(14),}}>• Payment and Taxation: </Text> The dividend is paid on the payment date, 
{`\n`}minus any applicable withholding taxes and local taxes.
{`\n`}{`\n`}
...
<Text style={{
 ...
 If you need help with a past dividend, click on "Help" and select the relevant dividend to start a chat.
  </Text>
