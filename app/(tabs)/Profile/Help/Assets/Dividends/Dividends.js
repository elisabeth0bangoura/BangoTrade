...
const categories = [
  {
    ...
    subcategories: [
      { name: 'Dividend Eligibility', 
        linkName: "DividendEligibility_Sheet",
       },
      { name: 'Dividend Cancellations',
        linkName: "DividendCancellations_Sheet",
       },
      { name: 'Dividend Receipts',
        linkName: "DividendReceipts_Sheet",
       },
      { name: 'Missed Dividends',
        linkName: "MissedDividends_Sheet",
       },
    ],
  },  
   ...
   const MyInvestmentsrenderItem = ({ item }) => {
    ...
    return (
      ...
      >
        ...
        <View style={{ }}>
          {/* Display Coin Name */}
          <Text numberOfLines={1} style={{textAlign: 'center', width: size(130), fontSize: size(16), alignSelf: 'center', marginTop: height(1), color: CurrentViewMode.Mode_fontColor, fontWeight: 'bold' }}>
            {item.name}
          </Text>
...
:
     ...
     <FlatList showsHorizontalScrollIndicator={false}  style={{
      ...
      <View style={{ marginTop: height(2), marginLeft: width(5), }}>
