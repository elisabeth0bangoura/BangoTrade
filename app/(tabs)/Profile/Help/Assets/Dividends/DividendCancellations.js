...
Occasionally, distributed dividends may be canceled later in the timeline.
...
<Text style={{ fontSize: size(14) }}>
  <Text style={{ fontWeight: "900", fontSize: size(14) }}>• Dividend Cancellation:</Text>
  {' '}Companies may cancel dividends on short notice.
</Text>
{`\n`}{`\n`}
<Text style={{ fontSize: size(14) }}>
  <Text style={{ fontWeight: "900", fontSize: size(14) }}>• Dividend Correction:</Text>
  {' '}If a dividend is paid incorrectly, the initial payment will be canceled, and a corrective payment will be made.
</Text>
{`\n`}{`\n`}
<Text style={{ fontSize: size(14) }}>
  <Text style={{ fontWeight: "900", fontSize: size(14) }}>• Reclassification of Dividends:</Text>
  {' '}Canadian and US companies, especially real estate investment trusts, may classify some dividends as capital distributions for tax purposes.
</Text>
{`\n`}{`\n`}
</Text>
...
<Text style={{
 ...
 If you need help with a past dividend, please click on "Help" and select a dividend to start a chat.
   </Text>
