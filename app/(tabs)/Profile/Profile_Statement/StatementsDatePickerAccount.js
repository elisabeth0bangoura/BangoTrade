...
export default function StatementsDatePickerAccount ()  {
  ...
  const { t } = useTranslation();
    ...
    const StatementsDatePickerAccount_Sheet = useRef(null)
    ...
    return(
      ...
      <ActionSheet ref={StatementsDatePickerAccount_Sheet}
               ...
               <TouchableOpacity onPress={() => {
                ...
                const fetchAndDownloadDocument = async () => {
                  ...
                  try {
                    ...
                    const response = await fetch(
                      `https://broker-api.sandbox.alpaca.markets/v1/accounts/${AlpacaUserId}/documents?type=account_statement`,
                      {
                        method: "GET",
                        headers: {
                          accept: "application/json",
