...
const ChooseDepositWay =  React.memo(({ AssetSupply}) => {
  ...
  const { CurrentViewMode, setCurrentViewMode, themes } = useContext(ViewModeContext);
    ...
    const ChooseDepositWay_Sheet = useRef(null);
 ...
 isModal={false} 
      ...
      />
        ...
        <Text style={{ fontSize: size(25), fontWeight: 'bold', width: "90%", 
         color: CurrentViewMode.Mode_fontColor, marginBottom: 20 }}>
          {t("ChooseDepositWayChooseAPaymentMethod")}
        </Text>
  ...
  export default ChooseDepositWay;